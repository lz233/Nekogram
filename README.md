...
3. If you're compiling DEBUG version, make sure your build variants is set to afatDebugMultidex.
4. You are ready to compile Nekogram. It takes time for the first-time build, be patient.
